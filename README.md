...
The recommended approach is to pass all paths directly to `parse_arguments()`, as shown in [`examples/example_filtered_optimization_cluster.py`](./examples/example_filtered_optimization_cluster.py):
