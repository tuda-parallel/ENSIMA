...
either expert knowledge or unskilled user choices. Executed on a GPU cluster —
set -ofs and -ofm to your local OpenForm solver and software paths before running.
...
if __name__ == "__main__":
    ...
    # Fixed input sequences — no optimization loop.
    # Each row is one simulation run. Switch mode between "expert" and "unskilled user".
    if "DACH-VWS" in args.jobname:
        mode = "unskilled user"
    ...
    # Filter by part using the expert CSV
