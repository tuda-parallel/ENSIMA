...
if __name__ == "__main__":
    parts = [
        ...
        (
            "Einleger",
            "/d/github/ENSIMA/artifacts/paper/TCO-Benchmark/PartType_04/Einleger.t52",
        ),
        (
            "ASaeule_BSym",
            "/d/github/ENSIMA/artifacts/paper/TCO-Benchmark/T52-PartFiles/A-Pilar.t52",
        ),
        (
            "Quertraeger",
        ...
        (
            "Kotfluegel-DC",
            "/d/github/ENSIMA/artifacts/paper/TCO-Benchmark/T52-PartFiles/FrontFender_B.t52",
        ),
        (
            "Heckklappe_aussen",
        ...
        (
            "SeatShell",
            "/d/github/ENSIMA/artifacts/paper/TCO-Benchmark/new_parts/PartType_03/SeatShell.t52",
        ),
        (
            "DACH-VWS-Session.ofs",
            "/d/github/ENSIMA/artifacts/paper/TCO-Benchmark/new_parts/PartType_01/DACH-VWS.t52",
        ),
        (
